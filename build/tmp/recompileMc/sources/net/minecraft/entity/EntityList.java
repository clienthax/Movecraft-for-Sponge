...
public class EntityList
{
    ...
    /**
     * A list of "old" entity names (used as IDs in versions prior to 1.11) and still used for translations.
     *  
     * @deprecated DO NOT USE. This field does not exist under forge, and mods using it will break if forge is
     * installed. Unfortunately, there is no direct replacement for the list, but {@link #getEntityString()} and {@link
     * #getTranslationName()} can be used for individual entities.
     */
